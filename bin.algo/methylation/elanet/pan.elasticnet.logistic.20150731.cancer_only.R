                      ...
                      p_thresh=0.05,q_thresh=0.05, type="ttest",parallel=F)
{
  ...
  #for debug
  #train_dat = train.dat; test_dat = test.dat; info=cisplatin.info;sig_gene=50;p_thresh=0.05;q_thresh=0.05;type="regression";parallel=T
  #
...
# #cisplatin.dat = read.table("cisplatin.methylation.gdac_20141206.preprocess.txt",header=T,row.names=1,sep="\t",quote="")
# cisplatin.dat = fread("cisplatin.methylation.gdac_20141206.preprocess.txt",data.table=F)
# cisplatin.info = read.table("cisplatin.methylation_fold_cv.mat.txt",sep="\t",header=T,quote="")
# test_fold=1
# output_folder = "."
# freq = 0.8
#both
...
#                      type=test_type, parallel=T,p_thresh=0.005)
# stopImplicitCluster()
# stopCluster(cl)
...
#                 nrow(train.dat)," probes are remained",sep="")
# print(tmp_str)
...
#delete probes
train.dat = train.dat[-seq(1,probe_num,by=1),]
test.dat = test.dat[-seq(1,probe_num,by=1),]
