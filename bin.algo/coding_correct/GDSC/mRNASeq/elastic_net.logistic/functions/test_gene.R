                      ...
                      parallel=F)
{
  ...
  #wilcox rank sum test, and logistic regression are also provided: "wilcox", "regression" for logistic regression
  #and "linear_regression" for multi-linear regression
