...
cisplatin.dat = read.table("cisplatin.mRNAseq.gdac_20141206.preprocess.txt",header=T,sep="\t",quote="",row.names=1)
...
setwd("C:/Users/zding/workspace/projects/drug_sensitivity/data/shuffle/shuffle_response.in_cancer/mRNA_seq")
for( shuffle.times in 1:100 )
{
  ...
  file_name = paste("cisplatin.mRNAseq_shuffle_info.",shuffle.times,".txt",sep="")
