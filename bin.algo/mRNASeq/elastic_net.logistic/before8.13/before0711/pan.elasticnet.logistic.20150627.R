...
list_tmp = test_gene(train.dat, test.dat, cisplatin.info, type=test_type)
...
tmp_str = paste(output_folder,"/pan.elanat.test_",test_fold-3,".20150701.pdf",sep="")
pdf(tmp_str)
...
tmp_str = paste("AUC = ",auc,sep="")
title("Test performance on Pan-cancer",tmp_str)
...
##middle results##
#CV AUCs#
tmp_str = paste(output_folder,"/pan.elasnet.cv_auc.test_",test_fold-3,"20150701.tiff",sep="")
tiff(tmp_str)
