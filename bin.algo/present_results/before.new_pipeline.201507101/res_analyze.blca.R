...
files = list.files(path="C:/Users/zding/workspace/projects/drug_sensitivity/results/omics_feature/cnv/cisplatin/elastic_net.logistic/single/BLCA/",
                   pattern="single.BLCA.elanet.cv_score.test_*",full.names=T)
...
files = list.files(path="C:/Users/zding/workspace/projects/drug_sensitivity/results/omics_feature/cnv/cisplatin/elastic_net.logistic/single/BLCA/",
                   pattern="single.BLCA.elanet.test_score.test_*",full.names=TRUE)
...
patient.info = read.table("C:/Users/zding/workspace/projects/drug_sensitivity/data/omics.drug_centric/cnv/cisplatin.gistic2.5_fold_cv.mat.txt",
                          header=T,sep="\t",quote="")
cisplatin.info = patient.info[as.character(patient.info$cancer)=="BLCA",]
###calculate AUC###
library(PRROC)
...
#add title
title("Peformance of Elastic Net Logistic Regression","Tumor BLCA;Drug Cisplatin; Omics CNV; Response two levels")
#add a legend
