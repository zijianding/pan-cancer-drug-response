...
ave_roc <- function(data, type="vertical",title_str,measure="sd")
{
  #data as a list of matrice
  #each matrix: tpr/fpr
...
###load data###
#lap-top#
# sin_path = "C:/Users/zding/workspace/projects/drug_sensitivity/results/omics_feature/mRNAseq/elastic_net/single/"
...
# core.cancer = "CECS"
# file_pattern = "single.elanet.mid_res.test_[0-9]*.20150701.txt"
#cluster#
...
stopImplicitCluster()
stopCluster(cl)
roc = ave_roc(roc_res,type="vertical",paste("Performance on",core.cancer),measure="sd")
title(NULL,"Vertical average;std bar")
roc = ave_roc(roc_res,type="vertical",paste("Performance on",core.cancer),measure="quantile")
title(NULL,"Vertical average;quantile bar")
roc = ave_roc(roc_res,type="threshold",paste("Performance on",core.cancer))
title(NULL,"Threshold average; sd bar")
...
error_calc(error_res,cisplatin.info,core.cancer)
