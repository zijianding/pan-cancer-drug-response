...
# cisplatin.dat = read.table("cisplatin.miRNAseq.gdac_20141206.preprocess.txt",header=T,row.names=1,sep="\t",quote="")
# cisplatin.info = read.table("cisplatin.miRNAseq_fold_cv.mat.txt",sep="\t",header=T,quote="")
# test_fold=1
# output_folder = "."
# freq = 0.8
#both
